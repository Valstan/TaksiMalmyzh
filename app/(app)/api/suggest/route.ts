...
// не получаем (nginx не передаёт X-Forwarded-For — M0.A §3.6, меньше чужих данных
// в системе). Скромный общий потолок защищает от заливки мусором; таргетированную
// атаку остановит модерация — мусор просто не публикуется.
