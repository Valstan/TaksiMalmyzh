  ...
  return (
    <header className="page-header">
      ...
      <nav className="top-nav">
        ...
        {/* Уведомление о данных стоит рядом со входом намеренно: это точка, где данные и
            появляются. Видно и невошедшему — ему как раз важно, что до входа мы не знаем,
            КТО он (метка устройства у краудсигналов при этом заводится, и страница про это
            говорит прямо). */}
